...
echo -e "  ${C_CYAN}void fastfetch${C_RESET}     View ASCII/Unicode system & edge telemetry"
echo -e "  ${C_CYAN}void start${C_RESET}         Start daemon supervisor + Telegram bot (foreground)"
echo -e "  ${C_CYAN}void start-bg${C_RESET}      Start as background daemon (keeps running 24/7)"
echo -e "  ${C_CYAN}void status${C_RESET}        View active service, RAM RSS, and hardware telemetry"
echo -e "  ${C_CYAN}void models${C_RESET}        Inspect local small-model weights & catalog"
...
echo ""
echo -e "${C_BOLD}Telegram Remote Control Setup (Optional):${C_RESET}"
echo -e "  Run the interactive onboarding wizard with auto-Admin ID detection:"
echo -e "     ${C_CYAN}void setup-bot${C_RESET}"
echo -e "  Or launch directly:"
echo -e "     ${C_CYAN}void start --telegram YOUR_BOT_TOKEN --admin-id YOUR_USER_ID${C_RESET}"
echo ""
